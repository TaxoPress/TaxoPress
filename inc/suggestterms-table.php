...
class SuggestTerms_List extends WP_List_Table
{
    ...
    /**
     * Retrieve st_suggestterms data from the database
     *
     * @param int $per_page
     ...
     * @return mixed
     */
    public static function get_st_suggestterms()
    {
        return taxopress_get_suggestterm_data();
    }
    ...
    {
        return count(taxopress_get_suggestterm_data());
    }
    ...
    public function prepare_items()
    {
         ...
         */
        $per_page = $this->get_items_per_page('st_suggestterms_per_page', 20);

        /**
         * Fetch the data
         */
        $data = self::get_st_suggestterms();
    ...
    protected function handle_row_actions($item, $column_name, $primary)
    {
        ...
        $actions = [
            'edit'   => sprintf(
                ...
                add_query_arg(
                    [
                        ...
                        'add'                    => 'new_item',
                        'action'                 => 'edit',
                        'taxopress_suggestterms' => $item['ID'],
                    ],
                    admin_url('admin.php')
                ),
            ...
            'delete' => sprintf(
                ...
                add_query_arg([
                    'page'                   => 'st_suggestterms',
                    'action'                 => 'taxopress-delete-suggestterm',
                    'taxopress_suggestterms' => esc_attr($item['ID']),
