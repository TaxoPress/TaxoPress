...
class SimpleTags_Related_Post
{
    ...
    public function page_manage_relatedposts()
    {
        ...
        if (!isset($_GET['add'])) {
            ...
            <div id="">
                <h1 class="wp-heading-inline"><?php _e('Related Posts', 'simpletags'); ?></h1>
                ...
                <form class="search-form wp-clearfix st-taxonomies-search-form" method="get">
                    <?php $this->terms_table->search_box(__('Search Related Posts', 'simpletags'), 'term'); ?>
                </form>
                <div class="clear"></div>
    ...
    public function taxopress_manage_relatedposts()
    {
        ...
        <div class="wrap <?php echo esc_attr($tab_class); ?>">
            ...
            <div class="wrap <?php echo esc_attr($tab_class); ?>">
                <h1><?php echo __('Manage Related Posts', 'simpletags'); ?></h1>
                                    ...
                                    <div class="postbox-header">
                                        <h2 class="hndle ui-sortable-handle">
                                            ...
                                            if ($related_post_edit) {
                                                echo esc_html__('Edit Related Posts', 'simpletags');
                                                ...
                                                echo esc_html__('Add new Related Posts', 'simpletags');
                                            }
                                            ?>
                                        </h2>
                                    </div>
                                                    ...
                                                    <table class="form-table taxopress-table">
                                                        ...
                                                        $select             = [
                                                            'options' => [
                                                                [
                                                                    'attr' => '',
                                                                    'text' => esc_attr__('None', 'simpletags')
                                                                ],
                                                                [
                                                                    'attr' => 'h1',
                                                                    'text' => esc_attr__('H1', 'simpletags')
                                                                ],
                                                                [
                                                                    'attr' => 'h2',
                                                                    'text' => esc_attr__('H2', 'simpletags')
                                                                ],
                                                                [
                                                                    'attr' => 'h3',
                                                                    'text' => esc_attr__('H3', 'simpletags')
                                                                ],
                                                                [
                                                                    'attr'    => 'h4',
                                                                    'text'    => esc_attr__('H4', 'simpletags'),
                                                                    'default' => 'true'
                                                                ],
                                                                [
                                                                    'attr' => 'h5',
                                                                    'text' => esc_attr__('H5', 'simpletags')
                                                                ],
                                                                [
                                                                    'attr' => 'h6',
                                                                    'text' => esc_attr__('H6', 'simpletags')
                                                                ],
                                                            ],
                                                        ];
                                                        ...
                                                        echo $ui->get_select_checkbox_input_main([
                                                            'namearray'  => 'taxopress_related_post',
                                                            'name'       => 'title_header',
                                                            'labeltext'  => esc_html__('Title header', 'simpletags'),
                                                            'selections' => $select,
                                                        ]);
                                                        ...
                                                        $options[] = [
                                                            ...
                                                            'text' => __('All post types', 'simpletags')
                                                        ];
                                                        $options[] = [
                                                            'attr'    => 'st_current_posttype',
                                                            'text'    => __('Current post type', 'simpletags'),
                                                            'default' => 'true'
                                                        ];
                                                        ...
                                                        echo '<tr valign="top"><th scope="row"><label>' . esc_html__('Attempt to automatically display related posts',
                                                                'simpletags') . '</label><br /><small style=" color: #646970;">' . esc_html__('TaxoPress will attempt to automatically display related posts in this content. It may not be successful for all post types and layouts.',
                                                    ...
                                                    <table>';
                                                        ...
                                                        $select             = [
                                                            'options' => [
                                                                [
                                                                    'attr' => '1',
                                                                    'text' => esc_attr__('24 hours', 'simpletags')
                                                                ],
                                                                [
                                                                    'attr' => '7',
                                                                    'text' => esc_attr__('7 days', 'simpletags')
                                                                ],
                                                                [
                                                                    'attr' => '14',
                                                                    'text' => esc_attr__('2 weeks', 'simpletags')
                                                                ],
                                                                [
                                                                    'attr' => '30',
                                                                    'text' => esc_attr__('1 month', 'simpletags')
                                                                ],
                                                                [
                                                                    'attr' => '180',
                                                                    'text' => esc_attr__('6 months', 'simpletags')
                                                                ],
                                                                [
                                                                    'attr' => '365',
                                                                    'text' => esc_attr__('1 year', 'simpletags')
                                                                ],
                                                                [
                                                                    'attr'    => '0',
                                                                    'text'    => esc_attr__('No limit', 'simpletags'),
                                                                    'default' => 'true'
                                                                ],
                                                            ],
                                                        ];
                                                        ...
                                                        $select             = [
                                                            'options' => [
                                                                ...
                                                                [
                                                                    'attr' => 'date-asc',
                                                                    'text' => esc_attr__('Older Entries', 'simpletags')
                                                                ],
                                                                [
                                                                    'attr' => 'date-desc',
                                                                    'text' => esc_attr__('Newer Entries', 'simpletags')
                                                                ],
                                                                [
                                                                    'attr' => 'name-asc',
                                                                    'text' => esc_attr__('Alphabetical', 'simpletags')
                                                                ],
                                                                [
                                                                    'attr' => 'name-desc',
                                                                ...
                                                                [
                                                                    'attr' => 'random',
                                                                    'text' => esc_attr__('Random', 'simpletags')
                                                                ],
                                                            ],
                                                        ];
