                                                ...
                                                <table class="form-table taxopress-table relatedpost_post_types"
                                                    ...
                                                    <?php
                                                        ...
                                                        echo '<tr valign="top"><th scope="row"><label>' . esc_html__('Post Types',
                                                                'simple-tags') . '</label><br /><small style=" color: #646970;">' . esc_html__('TaxoPress will display related posts from selected post types and also attempt to automatically display related posts in this content.',
