                                            ...
                                            ' . esc_html__('With TaxoPress Pro, you can create unlimited Related Posts. You can create Related Posts for any taxonomy and then display those Related Posts anywhere on your site.',
                                                    ...
                                                    <table>';
                                                        ...
                                                        echo $ui->get_text_input([
                                                            ...
                                                            'helptext'  => esc_html__('You can find markers and explanations <a target="blank" href="https://taxopress.com/docs/format-related-posts/">in the online documentation.</a>',
                                                                'simple-tags'),
                                                            'required'  => false,
                                                        ]);
