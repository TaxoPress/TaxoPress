...
class SimpleTags_Admin_Autocomplete {
	...
	public static function admin_enqueue_scripts() {
		...
		wp_register_script('jquery-autocomplete',		STAGS_URL.'/assets/js/lib/jquery.autocomplete/jquery.autocomplete.min.js', array('jquery', 'jquery-bgiframe'), '1.2.2');
		...
		wp_register_style ('jquery-autocomplete', 		STAGS_URL.'/assets/js/lib/jquery.autocomplete/jquery.autocomplete.css', array(), '1.2.2', 'all' );
