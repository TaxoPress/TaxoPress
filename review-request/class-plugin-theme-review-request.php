...
class Taxopress_Modules_Reviews {
	...
	public static function init() {
		...
		add_action( 'wp_ajax_taxopress_review_action', array( __CLASS__, 'ajax_handler' ) );
	}
	...
	public static function triggers( $group = null, $code = null ) {
		...
		if ( ! isset( $triggers ) ) {
			...
			$open_message = __( 'Hey, I noticed you recently hit %d popup views on your site – that’s awesome!. I would very much appreciate if you could quickly give it a 5-star rating on WordPress, just to help us spread the word.', 'simple-tags' );
			$time_message = __( "Hey, you've been using TaxoPress for %s on your site - I hope that its been helpful. I would very much appreciate if you could quickly give it a 5-star rating on WordPress, just to help us spread the word.", 'simple-tags' );

			$triggers = apply_filters( 'taxopress_reviews_triggers', array(
	...
	public static function admin_notices() {
		...
		<div class="notice notice-success is-dismissible prefix-notice">
			...
			<ul>
				<li>
					<a class="prefix-dismiss" target="_blank" href="https://wordpress.org/support/plugin/simple-tags/reviews/?rate=5#rate-response" data-reason="am_now">
