...
> This plugin is the free version of PublishPress Taxonomies. The Pro version of PublishPress Taxonomies has extra features and expert support. [Get the PublishPress Taxonomies Pro plugin now!](https://taxopress.com/taxopress)
...
Bug reports for PublishPress Taxonomies are welcomed in our [repository on GitHub](https://github.com/taxopress/taxopress). Please note that GitHub is not a support forum, but a place to report bugs in the plugn that can be replicated outside of a single site.

= Follow the PublishPress Taxonomies team =

Follow PublishPress Taxonomies on [Facebook](https://www.facebook.com/taxopress), [Twitter](https://www.twitter.com/taxopress) and [YouTube](https://www.youtube.com/taxopress).
